...
- Improve the visNetwork network package with additional options for analysis. This includes centrality analysis options such as betweenness and community detection.
...
To ensure that insights from the tool is reliable and can be admissible in court, the app should also be validated by forensic investigation specialists. It should also undergo a period of user testing to prove that it is error-free and can operate in all environment. 
