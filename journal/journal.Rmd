...
![Figure 1: A Venn Diagram showing the use of ‘Venn’ R package to show the intersections of 7 sets)](venn.png)
...
![Figure 2: Visualising GIS layers - ESRI’s ArcGIS Census Data Model](gis.png)
...
![Figure 3: Correlation between temperature vs. elevation, r = -0.6 (SAS , n.d.)](temp_elevation.png)
...
- id: rdrr2020
  ...
  issued:
    ...
    month: July  
- id: sasjmp
  title: Statistical Knowledge - What is Correlation
  type: Web site
  publisher: SAS
