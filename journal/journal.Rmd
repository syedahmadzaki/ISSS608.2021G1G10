...
To allow investigators to explore the surroundings of locations within a single app, the tmap package can be enhanced to link up to actual images of road and environment (e.g. Google Street Map).
