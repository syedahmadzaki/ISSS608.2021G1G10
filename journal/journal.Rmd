...
Addressing this challenge, we designed and developed Forensic Investigation App, an open-source interactive dashboard, to allow law enforcement agents to conduct investigative analysis of GPS and credit card data. It aims to simplify data exploration and analysis to gain valuable insights into the behaviour of individuals quickly. The study is built upon VAST Mini Challenge 2's task to find unusual patterns in GASTech employees credit card records and GPS tracking records of their cars. We demonstrate the potential of FIA with interactive maps to explore data exploration, inferential analysis and clustering of transactions and GPS data.
...
- How many visitors and who went to location A, B, C and D? 
...
- id: Sasjmp
  ...
  type: Web site
  publisher: SAS
  URL: ‘https://www.jmp.com/en_ch/statistics-knowledge-portal/
  what-is-correlation.html’
  

- id: Beniot2019
  title: Network Visualization using 'vis.js' Library
  author: Thieurmel, Benoit
