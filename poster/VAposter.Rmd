...
**Objective**<br>
  Designe and develop a Forensic Investigation App (FIA), an interactive dashboard that allows law enforcement agents to conduct investigative analysis of GPS and merchant card data. The application is built on VAST Mini Challenge 2's task to find unusual patterns in GASTech employees credit card records and GPS tracking records of their cars. 
...
\vspace{-100pt}
```{r pressure6, echo=FALSE, out.width = '80%', out.height='20%'}
knitr::include_graphics("vis.png")
```
\vspace{-100pt}

# FUTURE WORKS
The application could provide users an interface to upload, clean and step-by-step guide to transform data files into appropriate format for each visualization. In addition, tmap package can be enhanced to link up to actual images of road and environment.Lastly, visNetwork could have additional options for analysis, such as, community detection.
