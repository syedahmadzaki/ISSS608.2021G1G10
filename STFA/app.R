...
ui <-  fluidPage(useShinyjs(),
                 navbarPage(title = tagList("Forensic Investigation App",actionLink("sidebar_button","",
                                                                                    icon = icon("bars"),
                                                                                    tags$style(".fa-bars {color:#FFFFFF}")
                 )),
                 header = use_theme(create_theme(theme = "default",
                                                 bs_vars_navbar(
                 ...
                 # ----- Introduction Tab - Mainly a brief write-up of our project
                 tabPanel("Introduction",icon = icon("chalkboard-teacher"),
                          fluidRow(column(7,
                                          ...
                                          tags$div(
                                            ...
                                            tags$p("With the aid of curated visualisations, we aim to forensically understand and investigate any suspicious activities, 
                                                     leading up to the disappearance of several GasTech employees."),
                                            tags$p("This application is broken down into the different sections as per the image on the right."), style = "font-size:130%;"),
                                          tags$div("Within each tab, you'll be greeted with a sidebar, as well as a main panel. While the sidebar allows easy customisation for each visualisation,
                                            the main panel is divided into various sub-tabs. The first sub-tab is always a guide on the visualisation objectives as well as steps on its use. 
                                            Subsequent sub-tabs would showcase the visualisation itself.", style = "font-size:130%;"),
                                          br(),
                                          tags$div("As you explore the various tabs, do take advantage of the collapsible sidebar function. 
                                                     This is especially useful, when you want the visualisation to take up the whole width of your window.
                                                     The collapsible sidebar function is denoted by the three horizontal white lines located beside the VAST 2021 Mini Challenge 2 title above.", style = "font-size:130%;"),
                                          br(),
                                          tags$div("Click here to find out more information about the ",
                                                   tags$a(href="https://vast-challenge.github.io/2021/MC2.html", "VAST Challenge 2021"), ", as well as explore its accompanying dataset.", style = "font-size:130%;"),
                                          br(),
                                          tags$div("Alternatively, for more information on this project, do visit both our ",
                                                   tags$a(href="https://isss608-2021g1g10.netlify.app/proposal.html", "Group Project site"),
                                                   "and our ",
                                                   tags$a(href="https://github.com/syedahmadzaki/ISSS608.2021G1G10", "GitHub page."), style = "font-size:130%;"),
                                          br(),
                                          tags$div("Lastly, we would like to thank ",
                                                   tags$a(href="https://faculty.smu.edu.sg/profile/kam-tin-seong-486", "Professor Kam Tin Seong"),
                                                   " for his invaluable guidance and saintly patience in making this application a reality.", style = "font-size:130%;")
                          ),
                          column(5,
                                 h3(HTML("<b>App Overview</b>"), align = "center"),img(src = "overview1.png", width = "100%")
                          ))
                 ),
                 
                 # ----- ANOVA Tab - Statistical Analysis of Credit Card & Loyalty data
                 
                 tabPanel("ANOVA",icon = icon("tint"),
                          
                          sidebarLayout(
                            
                            # ----- ANOVA Side Bar - Basic and Advanced Settings for ANOVA Plot
                            ...
                            mainPanel(width = 9, fluid = TRUE,
                                      ...
                                      tabsetPanel(
                                        ...
                                        # ----- ANOVA Main Panel Sub-Tab – Instructions
                                        tabPanel("Guide",
                                                 br(),
                                                 fluidRow(column(6,
                                                                 ...
                                                                 tags$div(
                                                                   ...
                                                                   tags$p("It is important to realize that one-way ANOVA is an omnibus test statistic. It is unable to tell us which specific groups were statsitically significantly different from each other.
                                                                   ...
                                                                   tags$p("In our use case, we made use of credit card transaction data to showcase how such a visualization can help us understand the difference in spend amount across locations and credit card users.
                                        ...
                                        # ----- ANOVA Main Panel Sub-Tab - Exploratory Data Analysis
                                        tabPanel("EDA",
                                                 br(),
                                                 fluidRow(column(12,
                                                 ...
                                                 fluidRow(column(6,
                                                                 plotlyOutput("EDA_1A", height = 700, width = "100%")),
                                                          column(6,
                                                                 plotlyOutput("EDA_2A", height = 700, width = "100%"))
                                                 )
                                        ), 
                                        
                                        # ----- ANOVA Main Panel Sub-Tab - Statistical Analysis Between Locations
                                        tabPanel("ANOVA - Between Locations",
                                                 ...
                                                 fluidRow(column(8, 
                                                          ...
                                                          column(4, 
                                                                 h4(HTML("<b>Distribution of Spend Amount By Location</b>")),
                                        ...
                                        # ----- ANOVA Main Panel Sub-Tab - Statistical Analysis Between Credit Cards
                                        tabPanel("ANOVA - Between Credit Cards",
                                                 ...
                                                 fluidRow(column(8, 
                                                          ...
                                                          column(4, 
                                                                 h4(HTML("<b>Distribution of Spend Amount By Credit Card Numbers</b>")),
                 ...
                 # ----- UpSet Tab – Viewing Set Data
                 tabPanel("Upset Chart",icon = icon("chart-bar"),
                          
                          sidebarLayout(
                            
                            # ----- UpSet Side Bar – Basic and Advanced Settings for UpSet Chart
                            sidebarPanel(width=3, fluid = TRUE,
                                         h4(HTML("UpSet Plot Settings"), align = "center"),
                                         
                                         tabsetPanel(
                                           
                                           # ----- UpSet Side Bar Sub-Tab – Basic and Advanced Settings for UpSet Chart
                                           tabPanel('Settings',
                                                    br(),
                                                    
                                                    selectInput("granularity",
                                                                label = ("Co-Location Time Window"),
                                           ...
                                           # ----- UpSet Side Bar Sub-Tab – Basic and Advanced Formattings for UpSet Chart
                                           tabPanel("Format",
                                                    br(),
                                                    colourpicker::colourInput("mainbarcolor",
                                                                              label = h6("Select Main Bar Colour"),
                                                                              showColour = "background",
                                                                              "#214F8A"
                                                    ),
                                                    
                                                    colourpicker::colourInput("setbarcolor",
                                                    ...
                                                    numericInput("intersection_title_scale",
                            ...
                            mainPanel(width = 9, fluid = TRUE,
                                      ...
                                      tabsetPanel(
                                        ...
                                        # ----- UpSet Main Panel Sub-Tab – Instructions
                                        tabPanel("Guide",
                                                 br(),
                                                 fluidRow(column(6,
                                                                 ...
                                                                 tags$div(
                                                                   ...
                                                                   tags$p("It is made up of 3 parts:",
                                                                          tags$ol(
                                                                            tags$li("The total size of each set is represented on the bottom left barplot."),
                                                                            tags$li("Every possible intersection is represented by the bottom plot."),
                                                                            tags$li("Frequency of each intersection is shown on the top barplot.")
                                                                          )),
                                                                 ...
                                                                 tags$ol(
                                                                   tags$li("Begin by exploring the credit card transaction dataset under the 'EDA tab."),
                                                                   tags$li("Then select the time window of the co-location under 'Co-location time window'. 
                                                                             By selecting 'Hour', it means that the individuals were present at the location together in the same hour.
                                                                             The same individual can be present at different hours at the same location."),
                                                                   ...
                                                                   tags$li("Make use of the data table below the UpSet plot to drill down into intersections of interest to obtain the list individuals."),
                                                                   tags$li("Format the chart by selecting the bar colours and text sizes of your choice under 'Format' tab.")
                                                                 )
                                                 ), 
                                                 column(6,
                                                        tags$img(src="https://pbs.twimg.com/media/DDkuD6aWsAAP4N3?format=jpg&name=medium", width = "100%"),
                                        ...
                                        # ----- UpSet Main Panel Sub-Tab – Exploratory Data Analysis
                                        tabPanel("EDA",
                                                 br(),
                                                 fluidRow(column(12,
                                                                 h4(HTML("<b>Exploratory Data Analysis</b>"))
                                                 ...
                                                 fluidRow(column(6,
                                                                 plotlyOutput("EDA_1", height = 600)),
                                                          column(6,
                                                                 plotlyOutput("EDA_2", height = 600))
                                                 )
                                        ), 
                                        
                                        # ----- UpSet Main Panel Sub-Tab – UpSet Plot
                                        tabPanel("UpSet Plot", 
                                                 br(),
                                                 fluidRow(column(12,
                                                 ...
                                                 fluidRow(column(12,
                                                                 plotOutput("upset", height = 600)
                                                 ),
                                                 fluidRow(column(12,
                                                                 DTOutput('upset_table')
                                                 )
                                                 )
                                                 )
                                        )
                 ...
                 # ----- Heatmap Tab – Heatmap with Hierarchical Clustering
                 tabPanel("Heat Map ",icon = icon("th"),
                          
                          sidebarLayout(
                            
                            # ----- Heatmap Side Bar – Basic and Advanced Settings for Heatmap
                            sidebarPanel(width = 3, fluid = TRUE,
                                         h4("Heatmap Dendrogram Settings", align = "center"),
                                         ...
                                         sliderInput(inputId = "heat_cluster_row",
                                                     label = ("Select No. of Row Clusters"),
                                                     value = 3,
                                                     min = 1,
                                                     max = 10),
                                         
                                         sliderInput(inputId = "heat_cluster_column",
                                                     label = ("Select No. of Column Clusters"),
                                                     value = 3,
                                                     min = 1,
                                                     max = 10),
                            ...
                            mainPanel(width = 9, fluid = TRUE,
                                      ...
                                      tabsetPanel(
                                        ...
                                        # ----- Heatmap Main Panel Sub-Tab – Instructions
                                        tabPanel("Guide",
                                                 br(),fluidRow(column(6,
                                                                      h4(HTML("<b>Understanding Heat Map Feature</b>")),
                                                                      tags$div(
                                                                        tags$p("An interactive heat map dendrogram visualisation is provided, in the following tab, to allow you to understand the location visit frequency of each staff."), 
                                                                        tags$p("This map visualisation comes in two parts: the heat map itself and the dendrograms for both its row and column variables. The heat map allows you to zoom in, at your discretion, and see in detail their location preferences. 
                                                                      ...
                                                                      tags$ol(
                                                                        ...
                                                                        tags$li("Select the various heatmap dendrogram settings along with the cluster count that you would like to focus on."), 
                                                 ...
                                                 column(6,
                                                        img(src = "guide_heatmap.png", width = "100%")
                                                 )
                                                 )
                                        ),
                                        
                                        # ----- Heatmap Main Panel Sub-Tab – Exploration
                                        tabPanel("Heatmap",
                                                 br(),
                                                 fluidRow(column(12,
                 ...
                 # ----- Spatial Map Tab – Viewing Geolocations and Movements
                 tabPanel("Spatial Map",icon = icon("map-marked-alt"),
                          
                          sidebarLayout(position = "left", fluid = TRUE,
                                        
                                        # ----- Spatial Map Side Bar – Basic and Advanced Settings for UpSet Chart
                                        sidebarPanel(tags$style(".well {background-color:#e7e7e7;}"),width = 3, fluid = TRUE,
                                                     ...
                                                     fluidRow(column(6,
                                                                     colourpicker::colourInput(inputId = "id1colour",
                                                     ...
                                                     column(6,selectInput(inputId = "id1linetype",
                                                     ...
                                                     fluidRow(
                                                       column(6,
                                                              colourpicker::colourInput(inputId = "id2colour",
                                                     ...
                                                     fluidRow(column(6,colourpicker::colourInput(inputId = "id3colour",
                                        ...
                                        # ----- Spatial Map Main Panel
                                        mainPanel(width = 9, fluid = TRUE,
                                                  
                                                  tabsetPanel(
                                                    
                                                    # ----- Spatial Map Main Panel Sub-Tab – Instructions
                                                    tabPanel("Guide",
                                                             br(),
                                                             fluidRow(column(6,
                                                             ...
                                                             column(6,
                                                                    img(src = "guide_map.png", width = "100%")
                                                             )
                                                             )
                                                    ),
                                                    
                                                    # ----- Spatial Map Main Panel Sub-Tab – Map Exploration
                                                    tabPanel("Map",
                                                             br(),
                                                             fluidRow(column(12,
                                                             ...
                                                             tags$div(tags$br()),
                                                             fluidRow(width = 12,column(4, align = "center",
                 ...
                 # ----- Network Graph Tab – Understanding Relationships
                 tabPanel("Network Graph",icon = icon("project-diagram"),
                          
                          sidebarLayout(position = "left", fluid = TRUE,
                                        
                                        # ----- Network Graph Side Bar – Basic and Advanced Settings for UpSet Chart
                                        sidebarPanel(width = 3, fluid = TRUE,
                                                     ...
                                                     sliderInput(inputId = "fontsize",
                                                                 label = "Select Node Font Size",
                                                                 min = 0,
                                                                 max = 50,
                                                                 value = 25),
                                                     
                                                     sliderInput(inputId ="nodesize",
                                                                 label = "Select Node Size",
                                                                 min = 0,
                                                                 max =25,
                                                                 value = 25),
                                                     
                                                     selectInput(inputId = "variable3",
                                                                 label = "Select Edges Colour",
                                                     ...
                                                     sliderInput(inputId = "edgeopacity",
                                                                 label = "Select Edge Opacity",
                                                                 min = 0,
                                                                 max = 1,
                                                                 value = 0.5),
                                                     
                                                     selectInput(inputId = "variable4",
                                                                 label = "Select Vis Edges Option",
                                        ...
                                        # ----- Network Graph Main Panel
                                        mainPanel(width = 9, fluid = TRUE,
                                                  
                                                  tabsetPanel(
                                                    
                                                    # ----- Network Graph Main Panel Sub-Tab – Instructions
                                                    tabPanel("Guide",
                                                             br(),
                                                             fluidRow(column(6,
                                                                             h4(HTML("<b>Understanding the Network Graph Feature</b>")),
                                                                             tags$div(
                                                                               tags$p("Network Graphs are powered by graph theory, that transforms the entities and connections within datasets to nodes and edges respectively. These graphs can flesh out i) relationships between all the entities within the dataset; ii) number of connections each variable has; and iii) importance of relationships that connect variables. In addition to visualisation, Network Graphs can be statistically analysed to flesh out underlying relationships using methods such as, i) degree centrality – the number of ties a node has, and ii) eigenvector centrality – the node’s importance within the network."), 
                                                                               tags$p("The Network Graph provided uses two datasets, i) credit card expenditure-location, and ii) loyalty card expenditure – location. Specific credit card numbers, loyalty card numbers and locations can be selected within the graph. The graph can be customized to accommodate the user’s analysis."), 
                                                                               tags$p("For inferential analysis, select the Eigen and Degree analysis options. This highlights the important relationships and popular relationships respectively within the network. Important relationships include nodes that have few but well-connected connections. The node colours fade in tandem with relationship importance. Popular relationships are nodes with many connections.  "),
                                                                               tags$p("This Network Graph was created using the visNetwork package in R."), 
                                                                               tags$a(href="https://cran.r-project.org/web/packages/visNetwork/visNetwork.pdf", "Click here to find out more about the visNetwork R package.")),
                                                                             br(),
                                                                             h4(HTML("<b>Steps</b>")),
                                                                             tags$ol(
                                                                               tags$li("Begin by exploring the Network Graph under the Network Tab.."),
                                                                               tags$li("Select either credit card 'CC' or loyalty card 'LC' data."),
                                                                               tags$li("Click on the ‘Submit’ button to display the Network Graph."), 
                                                                               tags$li("Adjust the visual settings and click on the ‘Submit’ button to update the graph."), 
                                                                               tags$li("Select a node of interest by clicking on a node or by using the ‘Select by label’ drop-down option within the chart."),
                                                                               tags$li("Select either Eigen or Degree analysis under ‘Analysis Options’ and click on ‘Submit’ to understand the underlying relationships"),
                                                                             ),
                                                                             br(),
                                                                             br(),
                                                                             br()
                                                             ...
                                                             column(6,
                                                                    img(src = "visNetwork_guide.png", width = "100%")
                                                             )
                                                             )
                                                    ),
                                                    
                                                    # ----- Network Graph Main Panel Sub-Tab – Exploration
                                                    tabPanel("Network",
                                                             br(),
                                                             fluidRow(column(12,
...
server <- function(input, output,session) {
  ...
  output$ANOVAL <- renderPlot({
    ...
    isolate(a <- as.data.frame(plot_L$plot_env$subtitle_df))
    isolate(b <- as.data.frame(plot_L$plot_env$df_pairwise))
    plot_L
  })
  ...
  output$histC <- renderPlotly({
    ...
    isolate(hist <- ggplot(ANOVA_data %>% 
              ...
              geom_histogram(bins = input$bins) +
              facet_wrap(~last4ccnum, shrink = TRUE) +
              labs(y = "Frequency", x = "Price ($)") +
              theme_minimal() +
              theme(
                panel.background = element_blank(),
  ...
  My_data <- reactive({
    input$submitsetting
    isolate(if (input$granularity == "all"){
      My_dataset <- cc_csv
    }
    else if (input$granularity == "day"){
      My_dataset <- cc_csv_day
    }
    else if (input$granularity == "hour"){
      My_dataset <- cc_csv_hour
    })
    isolate(return(My_dataset))
  })
  ...
  # Retrieve elements of intersects by filtering DT
  output$upset_table <- renderDT({
    
    input$submitsetting
    isolate(
      if (input$granularity == "all"){
        DT::datatable(data = My_data() %>% dplyr::select(last4ccnum, Specific_sets()),
                      filter = "top",
                      options = list(
                        pageLength = 10,
                        scrollX = TRUE)
        ...
        DT::datatable(data = My_data() %>% dplyr::select(last4ccnum, day, Specific_sets()),
                      filter = "top",
                      options = list(
                        pageLength = 10,
                        scrollX = TRUE)
        ...
        DT::datatable(data = My_data() %>% dplyr::select(last4ccnum, day, hour, Specific_sets()),
                      filter = "top",
                      options = list(
                        pageLength = 10,
                        scrollX = TRUE)
    ...
    isolate(
      ...
      if (input$variable == "CC"){
        ...
        else 
        {
          ...
          visNetwork(dnodes, edges21, width = "100%") %>%
            visIgraphLayout(layout = input$variable1) %>%
            visNodes(
              size = input$nodesize,
              font = list(size = input$fontsize),
        ...
        if(input$analysis == "None"){
          visNetwork(lc_nodes21, lc_edges21, width = "100%") %>%
            visIgraphLayout(layout = input$variable1) %>%
            visNodes(
              size = input$nodesize,
              font = list(size = input$fontsize),
          ...
          visNetwork(lc_eigennodes, lc_edges21, width = "100%") %>%
            visIgraphLayout(layout = input$variable1) %>%
            visNodes(
              size = input$nodesize,
              font = list(size = input$fontsize),
