...
![Interactive Spatial Map.](spatial.png)
...
Furthermore, the application could include brushing-and-linking of different types of charts and embed drill-downs to provide details on demand, depending on the richness of the datasets.
