...
2. Merging data
a. Transactional dataset formed by merging both the credit card and loyalty data by timestap.
This would give an indication of the loyalty number - credit card number relationship.

b. Timeseries by transcational dataset formed by merging transactional data with GPS data.
This would give an indication of the location by credit card number.

c. Car Assignments by GPS data will connect the dots of the employee to location to credit card number. (not sure how?)
